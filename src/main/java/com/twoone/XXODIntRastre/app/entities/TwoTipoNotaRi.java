...
@AllArgsConstructor
@Data
@Table(name="TWO_TIPO_NOTA_RI")
public class TwoTipoNotaRi implements Serializable {

    @Id
    @Column(name="TIPO_NF_ID",length=15,nullable = false)
    ...
    @Column(name="ORGANIZATION_CODE",length=3,nullable = false)
    ...
    private Long importExpenseCcid;
    ...
    private Long rmaIcmsStReduction;
    ...
    private Timestamp paProcessDateFrom;
    ...
    @Column(name="INSS_AUTONOMOUS_TAX1")
    private Long inssAutonomousTax1;

    @Column(name="INSS_AUTONOMOUS_TAX2")
    private Long inssAutonomousTax2;

    @Column(name="INSS_AUTONOMOUS_TAX3")
    private Long inssAutonomousTax3;
    ...
    @Column(name="dtHrCriacao",nullable = false)
    private Timestamp dtHrCricao;
